...
#ifndef CHOCOMONAKA_BOARD_CONFIG_H_
#define CHOKOMONAKA_BOARD_CONFIG_H_

#include "enums.pb.h"
#include "class/hid/hid.h"

#define BOARD_CONFIG_LABEL "ChocoMonaka"
...
#define GPIO_PIN_00 GpioAction::BUTTON_PRESS_B4     // B2     | B      | A       | Circle   | 3      | K2     |
#define GPIO_PIN_07 GpioAction::BUTTON_PRESS_B1     // B3     | X      | Y       | Square   | 1      | P1     |
#define GPIO_PIN_05 GpioAction::BUTTON_PRESS_B2     // B4     | Y      | X       | Triangle | 4      | P2     |
...
#define GPIO_PIN_17 GpioAction::BUTTON_PRESS_S1     // S1     | Back   | Minus   | Select   | 9      | Coin   |
...
// Slider switch mapping
//
#define GPIO_PIN_21 GpioAction::SUSTAIN_SOCD_MODE_UP_PRIO
